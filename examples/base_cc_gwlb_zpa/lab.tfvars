...
cc_vm_prov_url = "connector.zscalerthree.net/api/v1/provUrl?name=aws-gwlb-small"

## 2. AWS Secrets Manager Secret Name from Secrets Manager E.g ZS/CC/credentials

secret_name = "bez/cc/secrets"
...
public_subnets                             = ["10.97.10.0/24"]
workloads_subnets                          = ["10.97.20.0/24"]
cc_subnets                                 = ["10.97.30.0/24"]
route53_subnets                            = ["10.97.40.0/24", "10.97.140.0/24"]
...
ssh_public_key_file = "~/lab/lab-ssh-key.pub"
